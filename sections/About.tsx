  ...
  return (
    <div className="flex flex-col lg:flex-row gap-20 text-xl leading-relaxed tracking-normal font-medium">
      <div className="flex-1">
        <p className="mb-5">
          I&#39;m a full time developer with over 5 years of professional
        ...
        <p className="mb-5">
          ...
          <span>
            ...
            <span className="text-[#bc4fc0] font-bold">Qwik</span>,cause I think
            it would be popular in the near future.
          </span>
        </p>
      </div>
      <div className="flex-1">
